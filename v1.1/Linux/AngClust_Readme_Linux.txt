...
2. Download AngClust_Linux_x64.jar or AngClust_Linux_x86.jar
...
4 Run AngClust
	See AngClust_Tutorial_Linux.mp4 at https://sourceforge.net/projects/AngClust/files/ 
	for tutorial.

	Open a 'Terminal' window
	Run 'java -jar AngClust_Linux_x64.jar' or 'java -jar AngClust_Linux_x86.jar'
