...
2. Download AngClust_Win_x64.jar or AngClust_Win_x86.jar
...
4. Run AngClust
	See AngClust_Tutorial_Windows.mp4 at https://sourceforge.net/projects/AngClust/files/ 
	for tutorial.
	
	Double click AngClust_Win_x64.jar or AngClust_Win_x86.jar to launch AngClust.
